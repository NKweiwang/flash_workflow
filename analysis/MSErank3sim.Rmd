...
PN.wrapper = function(Y_data,K = 3){
  ...
  g_flash = flashr2::flash_add_greedy(data,verbose=F,var_type = "constant",ebnm_fn = ebnm_pn, K = K)
...
```{r}
sparse_res = readRDS("../data/simulation/rankthree/boxplot.rds")
...
p3 = plot_res(sparse_diff,title = "Rank 3 example",methods_name = methods_name)
```
