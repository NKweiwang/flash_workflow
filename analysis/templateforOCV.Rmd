...
ml_res = readRDS("../data/missingvalue/OCVtemplate/RCCres/OCVNew20rep/movies100K/boxplot_cv.rds")
...
ML_res = ML_res[1:20,]
# add PN result
ML_pn_res = readRDS("../data/missingvalue/OCVtemplate/RCCres/OCVNew20rep/movies100K/box_cv_pn.rds")
...
plotM = plot_res(output,"MovieLens data",x_label = x_label)
...
GZ_res = GZ_res[1:20,]
# c("flash","NBSFA","PMD","softImpute")
gz_res = readRDS("../data/missingvalue/OCVtemplate/RCCres/OCVNew20rep/gtexzscore/box_cv.rds")
# flashG_rmse,nsfa_rmse,pmd_rmse,soft_rmse
gz_pn_res = readRDS("../data/missingvalue/OCVtemplate/RCCres/OCVNew20rep/gtexzscore/box_pn.rds")
...
x_label= c("flash","flash.pn","PMD","PMD.cv1","NBSFA","SI","SI.cv")
plotG = plot_res(output,"GTEx data",x_label = x_label)
...
x_label= c("flash","flash.pn","PMD","PMD.cv1","NBSFA","SI","SI.cv")
plotP = plot_res(output,"Text data",x_label = x_label)
...
DT_res = DT_res[1:20,]
# c("flash","NBSFA","PMD","softImpute")
dt_res = readRDS("../data/missingvalue/testingcode/box_denoiseTumor.rds")
# c("PN","flashG","flashGwn","flashB","nsfa","pmd","soft")

# the result order would be flashG PMD PMDcv NSFA SF SFcv
output = cbind(dt_res[,2],dt_res[,1],DT_res[,3],dt_res[,6],DT_res[,2],DT_res[,4],dt_res[,7])
x_label= c("flash","flash.pn","PMD","PMD.cv1","NBSFA","SI","SI.cv")
plotT = plot_res(output,"Tumor data",x_label = x_label)
