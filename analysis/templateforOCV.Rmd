...
call_method = function(Y_data,method,Kmax = 50){
  if(method == "flash"){
    ...
    # f_greedy = flashr2::flash_add_greedy(data,Kmax=Kmax,var_type = "constant")
    f_greedy = flashr2::flash_add_greedy(data,Kmax=Kmax)
    Y_hat = f_greedy$EL %*% t(f_greedy$EF)
  }else if(method == "flash_wn"){
    data = flashr2::flash_set_data(Y_data)
    # f_greedy = flashr2::flash_add_greedy(data,Kmax=Kmax,var_type = "constant",nullcheck=FALSE)
    f_greedy = flashr2::flash_add_greedy(data,Kmax=Kmax,nullcheck=FALSE)
    Y_hat = f_greedy$EL %*% t(f_greedy$EF)
    ...
    library(flashr2)
    data = flashr2::flash_set_data(Y_data)
    # f_greedy = flashr2::flash_add_greedy(data,Kmax=Kmax,ebnm_fn = ebnm_pn,var_type = "constant")
    f_greedy = flashr2::flash_add_greedy(data,Kmax=Kmax,ebnm_fn = ebnm_pn)
    Y_hat = f_greedy$EL %*% t(f_greedy$EF)
